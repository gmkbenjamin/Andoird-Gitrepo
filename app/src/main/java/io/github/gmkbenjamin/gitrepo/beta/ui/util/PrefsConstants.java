...
public enum PrefsConstants {
    SCP("scp", "false"),
    SSH_SHELL("ssh_shell", "false"),
    SSH_PORT("ssh_port", "2222"),
    GIT_REPOSITORIES_DIR("git_repositories_dir", Environment.getExternalStorageDirectory().getPath() + "/gitrepo/repositories"),
    STATUSBAR_NOTIFICATION("statusbar_notification", "true"),
    SSH_SERVICE_STARTUP("ssh_service_startup", "false"),
    REPO_BACKUP("repo_backup", "false"),
